...
describe('Various test code', function () {
    it('converts a string and maps', function () {
        var x = [{from: "bla", type: "Commercial Operator"},{from: "bla2", type: "Commercial Operator2"},{from: "bla3", type: "Commercial Operator3"}];
        assert.equal(x.map(function(i){return i.type}).join(", "), "Commercial")
